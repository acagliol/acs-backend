...
AWS_REGION = os.environ.get("CDK_AWS_REGION", os.environ.get("AWS_REGION"))
...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        if '/organizations/' in path:
            ...
            if len(path_parts) > 1:
                ...
                if '/members' in remaining_path:
                    ...
                    member_path = remaining_path.split('/members')[1]
                    if member_path and member_path.startswith('/'):
                        user_id = member_path[1:] if member_path[1:] else None
        ...
        elif http_method == 'POST' and path.endswith('/members/add'):
